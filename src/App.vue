...
<template>
  <div class="container todo-app">
    ...
    <div class="todo-app__main">
      <ul class="todo-list">
        ...
        >
          ...
          <button class="btn btn--delete" @click="removeTodo(index)" aria-label="Удалить">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="15" height="22">
              <path
    ...
    <div class="todo-app__footer" v-if="todos.length">
      ...
      <button class="btn btn--clear" :disabled="false" @click="clearCompleted()">
        Удалить завершенные
      </button>
      <button class="btn btn--clear" :disabled="false" @click="clearAll()">Очистить список</button>
    </div>
  </div>
</template>
